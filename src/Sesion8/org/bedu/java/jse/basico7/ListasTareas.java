...
import org.bedu.java.jse.basico7.Modelo.ListaTareas;
import org.bedu.java.jse.basico7.Modelo.Tarea;
...
public class ListasTareas {
    ...
    private static final String NOMBRE_ARCHIVO = System.getProperty("user.home") + "/.tareasgit";
